...
public class IntNode {
    ...
    public static void main(String[] args) {
        ...
        head.addNodeAfter(3);
        head.addNodeAfter(4);
        System.out.println("리스트 생성 및 노드 추가 후, 리스트 길이 : " + head.listLength(head));
        System.out.println("노드 데이터 4 출력 : " + head.listSearch(head, 4).data);

        head.removeNodeAfter();
        System.out.println("노드 4 삭제 후, 리스트 길이 : " + head.listLength(head));

        System.out.println("노드 데이터 3 출력 : " + head.listSearch(head, 3).data);
        System.out.println("노드 데이터 1 출력 : " + head.listSearch(head, 1).data);

        IntNode copyHead;
        copyHead = new IntNode(1, null);
        copyHead = listCopy(head);
        System.out.println("노드 복사 후, 새로 생성된 리스트 길이 : " + head.listLength(copyHead));
    }
}