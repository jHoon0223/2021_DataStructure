...
public class IntLinkedBag implements Cloneable {
     ...
     **/
    public Object clone( ) {  // Clone a nIntLinkedBag object.
        IntLinkedBag answer;
    ...
    public static void main(String[] args) {
        IntLinkedBag head1, head2;
        head1 = new IntLinkedBag();
        head2 = new IntLinkedBag();
        ...
        head1.add(3);
        head1.add(4);
        System.out.println("가방 생성 및 노드 추가 후, 가방의 총 크기 : " + head1.size());
        System.out.println("데이터 3의 총 개수 : " + head1.countOccurrences(3));

        head1.remove(3);
        System.out.println("데이터 3 삭제 후, 데이터 3의 총 개수 : " + head1.countOccurrences(3));
        System.out.println("데이터 3 삭제 후, 가방의 총 크기 : " + head1.size());

        head2.add(5);
        head2.add(6);
        head1.addAll(head2);
        System.out.println("두 가방을 합친 후, 가방의 총 크기 : " + head1.size());
    }
}